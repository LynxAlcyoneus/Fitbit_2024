...
public class Tuesday_Advanced extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tuesday_advanced);
...
// Define an array of video URIs
        ...
        String path8 = "android.resource://" + getPackageName() + "/" + R.raw.bicep_revrsecurls;
...
// Define an array of exercise sequence
        String[] sequence = {"Dead Lift", "Bend Over", "T Bar", "Push Down", "Barbell Curls", "CloseGrip Barbell", "Dumbell HammerCurls", "ReverseCurls"  };
        final int[] counter = {0};
