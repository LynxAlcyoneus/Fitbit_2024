...
public class Tuseday_Intermediate extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tuseday_intermediate);
...
// Define an array of video URIs
        ...
        String path3 = "android.resource://" + getPackageName() + "/" + R.raw.chest_dumbellflys;
        String path4 = "android.resource://" + getPackageName() + "/" + R.raw.tricep_overheadtriceosextension;
        String path5 = "android.resource://" + getPackageName() + "/" + R.raw.tricep_pushdown;
        String path6 = "android.resource://" + getPackageName() + "/" + R.raw.tricep_reversecabelsinglearm;
...
// Define an array of exercise sequence
        String[] sequence = {"Incline BarbellPress" ,"Decline BarbellPress", "Dumbell Flys", "OverHead Triceps Extension", "Cabel PushDown", "Reverse Single Arm"  };
        final int[] counter = {0};
