...
// Define an array of video URIs
        String path = "android.resource://" + getPackageName() + "/" + R.raw.leg_hacksquatmachine;
        String path1 = "android.resource://" + getPackageName() + "/" + R.raw.leg_legpress0;
        String path2 = "android.resource://" + getPackageName() + "/" + R.raw.leg_legcurls;
        String path3 = "android.resource://" + getPackageName() + "/" + R.raw.leg_barbelllunges;
        String path4 = "android.resource://" + getPackageName() + "/" + R.raw.leg_calfs;
...
// Define an array of exercise sequence
        String[] sequence = {"Leg Press","Leg Curls", "Barbell Lunges", "Calves"  };
        final int[] counter = {0};
        ...
        myButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (counter[0] < sequence.length) {
                    ...
                    Toast.makeText(getApplicationContext(), "Congratulation !! You have Completed Legs Workout", Toast.LENGTH_SHORT).show();
