...
public class Tricep_Workout extends AppCompatActivity {
...
// Define an array of video URIs
        String path = "android.resource://" + getPackageName() + "/" + R.raw.tricep_closegripbenchpress;
        String path1 = "android.resource://" + getPackageName() + "/" + R.raw.tricep_skullcrusher;
        String path2 = "android.resource://" + getPackageName() + "/" + R.raw.tricep_pushdown;
        String path3 = "android.resource://" + getPackageName() + "/" + R.raw.tricep_overheadtriceosextension;
        String[] videoUris = { path, path1, path2, path3 };
...
// Define an array of exercise sequence
        String[] sequence = {"Skull Crusher","Tricep PushDown", "Overhead Tricep Extension"  };
        final int[] counter = {0};
        ...
        myButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (counter[0] < sequence.length) {
                    ...
                    Toast.makeText(getApplicationContext(), "Congratulation !! You have Completed Triceps Workout", Toast.LENGTH_SHORT).show();
