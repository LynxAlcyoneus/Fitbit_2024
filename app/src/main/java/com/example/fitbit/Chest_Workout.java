...
// Define an array of video URIs
        ...
        String path4 = "android.resource://" + getPackageName() + "/" + R.raw.chest_dumbellpullover;
...
// Define an array of exercise sequence
        String[] sequence = {"Incline DumbellPress","Decline BarbellPress", "Pec Dec", "Dumbell PullOver"  };
        final int[] counter = {0};
        ...
        myButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (counter[0] < sequence.length) {
                    ...
                    Toast.makeText(getApplicationContext(), "Congratulation !! You have Completed Chest Workout", Toast.LENGTH_SHORT).show();
