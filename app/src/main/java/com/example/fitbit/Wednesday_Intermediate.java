...
public class Wednesday_Intermediate extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_wednesday_intermediate);
        ...
        myButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (counter[0] < sequence.length) {
                    ...
                    Toast.makeText(getApplicationContext(), "Congratulation !! You have Completed Quads-Shoulder Workout", Toast.LENGTH_SHORT).show();
