...
public class Monday_Intermediate extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_monday_intermediate);

// Define an array of video URIs
        String path = "android.resource://" + getPackageName() + "/" + R.raw.backpullups;
        String path1 = "android.resource://" + getPackageName() + "/" + R.raw.back_deadlift;
        String path2 = "android.resource://" + getPackageName() + "/" + R.raw.back_bendover;
        String path3 = "android.resource://" + getPackageName() + "/" + R.raw.back_tbar;
        String path4 = "android.resource://" + getPackageName() + "/" + R.raw.back_pushdown;
        String path5 = "android.resource://" + getPackageName() + "/" + R.raw.bicep_barbellcurl;
...
// Define an array of exercise sequence
        String[] sequence = {"Dead Lift", "Bend Over", "T Bar", "Push Down", "Barbell Curls", "CloseGrip Barbell", "Dumbell HammerCurls"  };
        final int[] counter = {0};
        ...
        myButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (counter[0] < sequence.length) {
                    ...
                    Toast.makeText(getApplicationContext(), "Congratulation !! You have Completed Back-Bicep Workout", Toast.LENGTH_SHORT).show();
