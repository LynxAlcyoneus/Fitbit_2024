...
public class Monday_Advanced extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_monday_advanced);
...
// Define an array of video URIs
        ...
        String path2 = "android.resource://" + getPackageName() + "/" + R.raw.chest_pecdec;
        String path3 = "android.resource://" + getPackageName() + "/" + R.raw.shoulder_machineshoulderpress;
        String path4 = "android.resource://" + getPackageName() + "/" + R.raw.shoulder_barbellfrontrise;
        String path5 = "android.resource://" + getPackageName() + "/" + R.raw.shoulder_cabelrevrsefly;
        String path6 = "android.resource://" + getPackageName() + "/" + R.raw.tricep_overheadtriceosextension;
        String path7 = "android.resource://" + getPackageName() + "/" + R.raw.tricep_pushdown;
        String path8 = "android.resource://" + getPackageName() + "/" + R.raw.tricep_reversecabelsinglearm;
...
// Define an array of exercise sequence
        String[] sequence = {"Incline DumbellPress", "Pec Dec", "Machine Shoulder Press", "Barbell FrontRaise", "Cabel Reverse Fly", "OverHead Triceps Extension", "Cabel PushDown", "Reverse Single Arm"  };
        final int[] counter = {0};
